<template>
  <div class="pb-40 bg-[#0d0e11]">
    <div className="relative w-full py-10">
      ...
      >
        <div
          className="w-1/2 flex flex-col justify-center  lg:col-span-7 lg:gap-x-6   xl:col-span-6"
        >
          <h1
    ...
    <div class="mx-auto container flex gap-10 pt-10 px-6">
      <div class="w-1/2">
        <div>
