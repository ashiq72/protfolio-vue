        ...
        <div
          ...
          <div class="w-8/12">
            <div class="w-fit h-full">
              <div ref="imageContainer" class="relative grid place-content-center overflow-hidden rounded-sm wrapper">
                ...
                <input type="range" min="0" max="100" v-model="position" aria-label="Percentage of before photo shown"
                  class="absolute inset-0 w-full h-full opacity-0 cursor-pointer" />
                <div class="absolute inset-0 w-0.5 h-full bg-white pointer-events-none slider-line"
                  :style="{ left: position + '%' }" aria-hidden="true"></div>
                <div
          ...
          <div
            ...
            <h1 className="mt-8 text-xl font-bold tracking-tight text-black md:text-xl lg:text-2xl">
