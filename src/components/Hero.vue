<template>
  <div>
    ...
    <section class="py-12 bg-[#0d0e11] sm:pb-16 lg:pb-20 xl:pb-24">
        <div class="px-4 mx-auto sm:px-6 lg:px-8 container">
            <div class="relative">
                <div class="lg:w-2/3 pt-6">
                    ...
                    <div class="relative inline-flex items-center justify-center mt-8 sm:mt-12 group">
                        ...
                        <a href="/contact" title="" class="relative inline-flex items-center justify-center px-8 py-3 text-base font-normal text-white bg-black border border-transparent rounded-full" role="button">
                        Contact us
                        </a>
                    </div>
                ...
                <div class="mt-8 md:absolute md:mt-0 md:top-32 lg:top-0 md:right-0">
                    <img class="w-full max-w-xs mx-auto lg:max-w-lg xl:max-w-xl" src="https://bponi.sgp1.cdn.digitaloceanspaces.com/bponi/file/b339251f-0424-4833-9940-091b168238b8.jpg" alt="" />
                </div>
            </div>
        </div>
    </section>
