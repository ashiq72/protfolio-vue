          ...
          <div class="col-span-3 ">
            <div class="max-w-sm mt-8 md:mt-0">
              <ul class="space-y-7">
                ...
                <li>
                  <a href="mailto:hello.graphicalcreative@gmail.com" target="_blank" class="flex items-start">
                    <svg class="flex-shrink-0 w-6 h-6 text-white" xmlns="http://www.w3.org/2000/svg" fill="none"
                      viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <li>
                  <a href="https://wa.me/8801849989679" target="_blank" class="flex items-start">
            ...
            <ul class="flex items-center justify-center mt-12 space-x-6">
              <li>
                <a href="https://x.com/hello_graphical?prefetchTimestamp=1722579697401" target="_blank" title=""
                  rel="noopener"
              ...
              <li>
                <a href="https://www.linkedin.com/in/graphicalcreative/" target="_blank" title="" rel="noopener"
                  class="inline-flex transition-all duration-200 rounded text-white focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-primary focus:ring-offset-secondary">
