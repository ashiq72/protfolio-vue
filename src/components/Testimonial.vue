    ...
    <Flicking :key="'5'" :options="{
      ...
      <div class="flex flex-col  shadow-xl w-fit md:w-[400px] h-[300px] ml-4 ">
        <div class="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7 rounded-md">
          ...
          <div class="flex items-center mt-8">
            <img class="flex-shrink-0 object-cover rounded-full w-11 h-11"
      ...
      <div class="flex flex-col  shadow-xl w-fit md:w-[400px] ml-4 rounded">
        <div class="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
          ...
          <div class="flex items-center mt-8">
            <img class="flex-shrink-0 object-cover rounded-full w-11 h-11"
              src="https://cdn.rareblocks.xyz/collection/clarity/images/testimonial/4/avatar-male-2.png" alt="" />
            <div class="ml-4">
              <p class="text-base font-bold text-gray-900 font-pj">
                Jacob Jones
              </p>
      ...
      <div class="flex flex-col  shadow-xl w-fit md:w-[400px] ml-4 rounded">
        <div class="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
          ...
          <div class="flex items-center mt-8">
            <img class="flex-shrink-0 object-cover rounded-full w-11 h-11"
              src="https://cdn.rareblocks.xyz/collection/clarity/images/testimonial/4/avatar-female.png" alt="" />
            <div class="ml-4">
              <p class="text-base font-bold text-gray-900 font-pj">
                Jenny Wilson
              </p>
