    ...
    <div class="container mx-auto">
      ...
      >
        <div class="flex flex-col shadow-xl w-fit md:w-[400px] h-[300px] ml-4">
          <div
            class="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7 h-[350px] rounded-md"
          >
            <div class="flex-1">
        ...
        <div class="flex flex-col shadow-xl w-fit md:w-[400px] ml-4 rounded">
          <div
            class="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7 h-[350px]"
          >
            <div class="flex-1">
              <div class="flex items-center">
                <svg
