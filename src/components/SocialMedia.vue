    ...
    <div class="container mx-auto px-4">
      <div class="grid gird-cols-1 lg:grid-cols-[8fr_4fr] gap-8">
        <div class="left flex items-center rounded-[50px] bg-[#0d0e11] p-10">
          <div class="left-left">
            <p class="text-[#f8d315] text-2xl pt-10">Got a project in mind?</p>
            <h2 class="text-white text-5xl pb-10 font-bold">
              Let's discuss the details
            </h2>
            <button class="px-4 py-2 bg-purple-700 text-white rounded-full">
              Contact Us
            </button>
          </div>
          <div class="left-right">
            <img
              src="https://bponi.sgp1.cdn.digitaloceanspaces.com/bponi/file/5a2b72d0-5cbf-48b3-ac3e-c216790f5336.png"
              alt=""
            />
          </div>
        </div>
        ...
        >
          <div class="right-inner bg-gray-400 rounded-full w-fit">
            <img
              src="https://bponi.sgp1.cdn.digitaloceanspaces.com/bponi/file/2b95abbd-600f-4f09-ae19-b447527e675f.png"
              alt=""
            />
          </div>
          <h3 class="font-thin text-white text-2xl">
            My Name is Noman, I am a graphic designer. I will answer all your
            questions.
          </h3>
          <a
