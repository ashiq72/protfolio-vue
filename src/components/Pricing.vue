<template>
  <section className="relative w-full overflow-hidden bg-white py-20">
    <div class="flex items-center justify-center flex-col pb-10">
      <h1 class="font-bold text-2xl font-serif">Select Your Perfect Plan</h1>
      <p>Enjoy Up to 20% Discount on Bulk Orders</p>
    </div>
            ...
            <div className="rounded-md border bg-white bg-opacity-90">
              <div className=" border-b">
                <div className="px-9 py-7">
                  <h3
                    className="mb-3 text-xl font-bold leading-snug text-gray-900"
                  >
                    Standard
                  </h3>
              ...
              <div className="px-9 pb-9 pt-8">
                ...
                <p
                  className="mb-6 text-lg font-semibold leading-normal text-gray-600"
                >
